...
class Page_Action extends StatefulWidget {
  _BirdState createState() => new _BirdState();
}

class _BirdState extends State<Page_Action> {
  @override
...
//          color: Colors.white,
          child: new StaggeredGridView.countBuilder(
            ...
            return buildGestureDetector(
                ...
                onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context)=> Details_Action(
