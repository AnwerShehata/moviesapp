      ...
      import '../Model/MyData_MoviesWars.dart';
      import '../Pages/Page_Wars.dart';

      class Details_Wars extends StatefulWidget {
        final String name;
        final String description;
        final String imagUrl;
        final String videoUrl;
    const Details_Wars({Key key, this.name, this.description, this.imagUrl, this.videoUrl}) : super(key: key);
        _BirdState createState() => new _BirdState();
      }

      class _BirdState extends State<Details_Wars> {
                ...
                new SingleChildScrollView(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      SizedBox(height: 30),
                      _NmeSection(nameSection: "المزيد من افلام الحروب",
                          onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => Page_Wars()),);}),
                      new Container(
                          height: 220,
                          ...
                          child: ListView.builder(
                            reverse: true,
                              ...
                              itemBuilder: (context ,postions){
                                return _itemsMovies(
                                  imag: "${dataMoviWars[postions].imagUrl}" ,
                                  name: "${dataMoviWars[postions].name.substring(0,0)}...",
                                  onTapp:(){Navigator.push(context, MaterialPageRoute(builder: (context) => Details_Wars(
                                    name: dataMoviWars[postions].name,
                                    imagUrl:dataMoviWars[postions].imagUrl ,
                                    description: dataMoviWars[postions].description,
                                    videoUrl: dataMoviWars[postions].videoUrl,
                                  )),);},
                                );
                              })
                      ),
