      ...
      class Details_Anmination extends StatefulWidget {
        final String name;
        final String description;
        final String imagUrl;
        final String videoUrl;
    const Details_Anmination({Key key, this.name, this.description, this.imagUrl, this.videoUrl}) : super(key: key);
        _BirdState createState() => new _BirdState();
      }

      class _BirdState extends State<Details_Anmination> {
